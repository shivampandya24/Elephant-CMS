                                    ...
                                    <tr data-entry-id="{{ $faqCategory->id }}">
                                        ...
                                        <td>
                                            @can('faq_category_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.faq-categories.show', $faqCategory->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('faq_category_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.faq-categories.edit', $faqCategory->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('faq_category_delete')
                                                <form action="{{ route('frontend.faq-categories.destroy', $faqCategory->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('faq_category_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.faq-categories.massDestroy') }}",
